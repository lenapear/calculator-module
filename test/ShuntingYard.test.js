...
// --- ShuntingYard helper method tests ---

const syHelper = new ShuntingYard()

console.log("getPrecedence('+'):", syHelper.getPrecedence("+")) // expected: 1
console.log("getPrecedence('*'):", syHelper.getPrecedence("*")) // expected: 2

console.log("hasPrecedence('*','+'):", syHelper.hasPrecedence("*", "+")) // true
console.log("hasPrecedence('+','*'):", syHelper.hasPrecedence("+", "*")) // false
